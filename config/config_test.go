...
func TestNotValidConfigStorage(t *testing2.T) {
	...
	os.Setenv("EXPO_APPS_JSON", `[{"id":"test","accessToken":"test","keys":{"mode":"environment","publicB64":"LS0tLS1CRUdJTiBURVNUIEtFWS0tLS0tCnRlc3RkYXRhCi0tLS0tRU5EIFRFU1QgS0VZLS0tLS0K","privateB64":"LS0tLS1CRUdJTiBURVNUIEtFWS0tLS0tCnRlc3RkYXRhCi0tLS0tRU5EIFRFU1QgS0VZLS0tLS0K"}}]`)
	ResetAppsForTest()
