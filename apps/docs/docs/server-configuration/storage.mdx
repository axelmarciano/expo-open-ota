...
**Expo Open OTA** supports two storage solutions for hosting your update assets: **Local File System** and **Amazon S3**. This guide will help you set up your storage solution and configure your server to use it.
