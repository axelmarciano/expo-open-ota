      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "max(\n  sum by (instance) (global_active_users_total{appId=~\"$appId\"})\n)",
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "max by (runtime, update) (\n  sum by (appId, platform, runtime, branch, update, instance) (\n    active_users_total{appId=~\"$appId\", platform=~\"$platform\", runtime=~\"$runtime\", branch=~\"$branch\", update=~\"$update\"}\n  )\n)",
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "max by (platform) (\n  sum by (platform, instance) (\n    global_active_users_total{appId=~\"$appId\", platform=~\"$platform\"}\n  )\n)",
          "legendFormat": "{{platform}}",
          "range": true,
          "refId": "A"
        }
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "sum(update_error_users_total{appId=~\"$appId\", platform=~\"$platform\", runtime=~\"$runtime\", branch=~\"$branch\", update=~\"$update\"})\n  by (update)",
          "legendFormat": "{{platform}}",
          "range": true,
          "refId": "A"
        }
      ...
      "targets": [
        {
          ...
          "expr": "sum(update_downloads_total{appId=~\"$appId\", platform=~\"$platform\", runtime=~\"$runtime\", branch=~\"$branch\", update=~\"$update\"}) by (update)",
          "legendFormat": "{{update}}",
          "refId": "A"
        }
      ],
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "sum(update_downloads_total{appId=~\"$appId\", platform=~\"$platform\", runtime=~\"$runtime\", branch=~\"$branch\", update=~\"$update\"}) by (runtime)",
          "legendFormat": "{{update}}",
          "range": true,
          "refId": "A"
        }
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "sum by (update, runtime) (update_downloads_total{appId=~\"$appId\", platform=~\"$platform\", runtime=~\"$runtime\", branch=~\"$branch\", update=~\"$update\", updateType=~\"$updateType|.*\"})",
  ...
  "templating": {
    "list": [
      ...
      },
      {
        ...
        "name": "appId",
        "options": [],
        "query": "label_values(active_users_total, appId)",
        "refresh": 1,
        "type": "query"
      },
      {
