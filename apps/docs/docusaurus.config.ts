...
const config: Config = {
  title: 'Expo Open OTA',
  tagline:
    'Self-hosted OTA updates for React Native. Multi-cloud (AWS S3, Google Cloud Storage), CDN-ready, and production-grade — an open-source Go server implementing the Expo Updates protocol.',
